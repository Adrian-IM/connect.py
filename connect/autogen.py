...
class connect_Config:
    ...
    def getData(self,key):
        return self.data.h.get(key,None)
...
class connect_Dictionary(haxe_ds_StringMap):
    _hx_class_name = "connect.Dictionary"
    __slots__ = ()
    _hx_fields = []
    _hx_methods = ["getBool", "getInt", "getFloat", "getString", "getObject", "setBool", "setInt", "setFloat", "setString", "setObject", "toObject"]
    _hx_statics = ["fromObject", "toObject_r", "fromObject_r"]
    _hx_interfaces = []
    _hx_super = haxe_ds_StringMap
    ...
    def toObject_r(x):
        ...
        if (_g.index == 6):
            ...
            if (_g1 == connect_Collection):
                ...
                while key.hasNext():
                    key1 = key.next()
                    value = connect_Dictionary.toObject_r(_hx_dict.h.get(key1,None))
    ...
    def fromObject_r(x):
        ...
        if (tmp == 4):
            ...
            while (_g1 < len(fields)):
                ...
                _g1 = (_g1 + 1)
                value = connect_Dictionary.fromObject_r(Reflect.field(x,field))
                _hx_dict.h[field] = value
            return _hx_dict
        elif (tmp == 6):
            if (_g.params[0] == list):
                arr = x
...
class connect_Env:
    ...
    def loadConfig(filename):
        if (connect_Env.config is None):
            ...
            apiUrl = _hx_dict.h.get("apiEndpoint",None)
            apiKey = _hx_dict.h.get("apiKey",None)
            products = None
            _g = Type.typeof(_hx_dict.h.get("products",None))
            if (_g.index == 6):
                _g1 = _g.params[0]
                if (_g1 == str):
                    products = connect_Collection._fromArray([_hx_dict.getString("products")])
                elif (_g1 == connect_Collection):
                    products = _hx_dict.h.get("products",None)
                else:
                    pass
    ...
    def init(deps = None):
        ...
        if (connect_Env.dependencies is None):
            ...
            if (deps is not None):
                ...
                while key.hasNext():
                    key1 = key.next()
                    if (key1 in connect_Env.defaultDependencies.h):
    ...
    def createInstance(interfaceName):
        connect_Env.init()
        className = (connect_Env.dependencies.getString(interfaceName) if ((interfaceName in connect_Env.dependencies.h)) else connect_Env.defaultDependencies.getString(interfaceName))
...
class connect_Processor:
    ...
    __slots__ = ("steps", "model", "data", "skip_", "saveStep")
    _hx_fields = ["steps", "model", "data", "skip_", "saveStep"]
    _hx_methods = ["step", "run", "getRequest", "setData", "getData", "approveByTemplate", "approveByTile", "fail", "inquire", "pend", "skip", "logStepData", "getClassName"]
    _hx_statics = ["STEP_PARAM_ID", "removeStepData", "getDate"]
    ...
    def step(self,description,func):
        _this = self.steps
        x = connect__Processor_Step(description,func)
        _this.append(x)
        return self
    ...
    def run(self,modelClass,filters):
        ...
        connect_Env.getLogger().openSection(((("Running " + HxOverrides.stringOrNull(self.getClassName())) + " on ") + HxOverrides.stringOrNull(connect_Processor.getDate())))
        connect_Env.getLogger().openSection(("Listing requests on " + HxOverrides.stringOrNull(connect_Processor.getDate())))
        _hx_list = None
        try:
        ...
        while model.hasNext():
            ...
            if (self.getRequest() is not None):
                connect_Env.getLogger().openSection(((((("Processing request \"" + HxOverrides.stringOrNull(self.model.id)) + "\" for asset \"") + HxOverrides.stringOrNull(self.getRequest().asset.id)) + "\" on ") + HxOverrides.stringOrNull(connect_Processor.getDate())))
            else:
                connect_Env.getLogger().openSection(((("Processing request \"" + HxOverrides.stringOrNull(self.model.id)) + "\" on ") + HxOverrides.stringOrNull(connect_Processor.getDate())))
            if ((self.getRequest() is not None) and self.getRequest().needsMigration()):
                ...
                firstIndex = 0
                if ((((self.getRequest() is not None) and ((self.getRequest().asset.getParamById("__sdk_processor_step") is not None))) and ((self.getRequest().asset.getParamById("__sdk_processor_step").value is not None))) and ((self.getRequest().asset.getParamById("__sdk_processor_step").value != ""))):
                    param = self.getRequest().asset.getParamById("__sdk_processor_step")
                    if ((param.value is not None) and connect_Inflection.isJsonObject(param.value)):
                        ...
                        if python_Boot.hasField(storeData,self.model.id):
                            stepData = Reflect.field(storeData,self.model.id)
                            firstIndex = stepData.current_step
                            input = stepData.input
                            fields = python_Boot.fields(stepData.data)
                            _g2 = 0
                            while (_g2 < len(fields)):
                                field = (fields[_g2] if _g2 >= 0 and _g2 < len(fields) else None)
                                _g2 = (_g2 + 1)
                                ...
                                value = Reflect.field(stepData.data,field)
                                parsedValue = (connect_models_Model.parse(Type.resolveClass(fieldClass),value) if ((fieldClass != "")) else value)
                                self.setData(fieldName,parsedValue)
                    connect_Env.getLogger().info(("Resuming request from step " + Std.string(((firstIndex + 1)))))
                _g21 = firstIndex
                _g3 = len(self.steps)
                while (_g21 < _g3):
                    index = _g21
                    ...
                    try:
                        ...
                        connect_Env.getLogger().error("```")
                        connect_Env.getLogger().error(Std.string(ex1))
                        connect_Env.getLogger().error("```")
                        connect_Env.getLogger().error("")
                        self.skip(True)
                    if self.skip_:
                        if ((self.getRequest() is not None) and self.saveStep):
                            connect_Env.getLogger().info("Skipping request.")
                            if ((self.getRequest() is not None) and ((self.getRequest().asset.getParamById("__sdk_processor_step") is not None))):
                                connect_Env.getLogger().info("Saving step data.")
                                data = _hx_AnonObject({})
                                key = self.data.keys()
                                while key.hasNext():
                                    key1 = key.next()
                                    value1 = self.data.h.get(key1,None)
                                    className = (Type.getClassName(Type.getClass(value1)) if (Std._hx_is(value1,connect_models_Model)) else "")
                                    field1 = ((("" + ("null" if key1 is None else key1)) + "::") + ("null" if className is None else className))
                                    setattr(data,(("_hx_" + field1) if ((field1 in python_Boot.keywords)) else (("_hx_" + field1) if (((((len(field1) > 2) and ((ord(field1[0]) == 95))) and ((ord(field1[1]) == 95))) and ((ord(field1[(len(field1) - 1)]) != 95)))) else field1)),value1)
                                storeData1 = _hx_AnonObject({})
                                field2 = self.model.id
                                setattr(storeData1,(("_hx_" + field2) if ((field2 in python_Boot.keywords)) else (("_hx_" + field2) if (((((len(field2) > 2) and ((ord(field2[0]) == 95))) and ((ord(field2[1]) == 95))) and ((ord(field2[(len(field2) - 1)]) != 95)))) else field2)),_hx_AnonObject({'current_step': index, 'input': input, 'data': data}))
                                param1 = self.getRequest().asset.getParamById("__sdk_processor_step")
                                param1.value = haxe_format_JsonPrinter.print(storeData1,None,None)
                                try:
                                    self.getRequest().update()
                                except Exception as _hx_e:
                                    _hx_e1 = _hx_e.val if isinstance(_hx_e, _HxException) else _hx_e
                                    ex2 = _hx_e1
                                    connect_Env.getLogger().error("```")
                                    connect_Env.getLogger().error(Std.string(ex2))
                                    connect_Env.getLogger().error("```")
                                    connect_Env.getLogger().error("")
                        connect_Env.getLogger().closeSection()
                        break
    ...
    def approveByTemplate(self,id):
        ...
        if (request is not None):
            connect_Processor.removeStepData(request)
...
class connect__Processor_Step:
    _hx_class_name = "connect._Processor.Step"
    ...
    def _hx_empty_init(_hx_o):
        ...
        _hx_o.func = None
connect__Processor_Step._hx_class = connect__Processor_Step
_hx_classes["connect._Processor.Step"] = connect__Processor_Step
...
class connect_api_Response:
    _hx_class_name = "connect.api.Response"
    __slots__ = ("status", "text")
    _hx_fields = ["status", "text"]
...
class connect_api_impl_ApiClientImpl:
    ...
    def syncRequest(self,method,url,headers,body,fileArg,fileName,fileContent):
        ...
        if (headers is not None):
            ...
            while key.hasNext():
                key1 = key.next()
                parsedHeaders[key1] = headers.h.get(key1,None)
        response = None
        try:
            response = connect_native_PythonRequest.request(method,url,parsedHeaders,body,300)
        except Exception as _hx_e:
            _hx_e1 = _hx_e.val if isinstance(_hx_e, _HxException) else _hx_e
            ex = _hx_e1
            if (connect_Env.getLogger().getLevel() == 0):
    ...
    def postFile(self,resource,id = None,suffix = None,fileArg = None,fileName = None,fileContents = None):
        return self.checkResponse(self.connectSyncRequest("POST",self.parsePath(resource,id,suffix),self.getHeaders("multipart/form-data"),None,fileArg,fileName,fileContents))
    ...
    def getHeaders(self,contentType = None):
        ...
        value = connect_Env.getConfig().getApiKey()
        headers.h["Authorization"] = value
    ...
    def writeRequestCall(self,loggerFunc,method,url,headers,body):
        ...
        if ((loggerFunc != connect_Env.getLogger().debug) and ((headers is not None))):
            ...
            while key.hasNext():
                ...
                if (key1 == "Authorization"):
                    auth = Std.string(headers.h.get("Authorization",None))
                    ...
                    maskedHeaders.h["Authorization"] = auth
                else:
                    value = headers.h.get(key1,None)
                    maskedHeaders.h[key1] = value
        ...
        if (maskedHeaders is not None):
            ...
            while key2.hasNext():
                key3 = key2.next()
                Reflect.callMethod(connect_Env.getLogger(),loggerFunc,[(((("> | " + ("null" if key3 is None else key3)) + " | ") + Std.string(maskedHeaders.h.get(key3,None))) + " |")])
        if (body is not None):
...
class connect_api_impl_FulfillmentApiImpl:
...
class connect_api_impl_GeneralApiImpl:
...
class connect_api_impl_TierApiImpl:
...
class connect_api_impl_UsageApiImpl:
    ...
    def createUsageFile(self):
        return connect_Env.getApiClient().post("usage/files")

    def getUsageFile(self,id):
        return connect_Env.getApiClient().get("usage/files",id)

    def updateUsageFile(self,id,file):
        return connect_Env.getApiClient().put("usage/files",id,file)

    def deleteUsageFile(self,id):
        connect_Env.getApiClient().post("usage/files",id,"delete")

    def uploadUsageFile(self,id,file):
        return connect_Env.getApiClient().post("usage/files",id,"upload",file)

    def submitUsageFileAction(self,id):
        return connect_Env.getApiClient().post("usage/files",id,"submit")

    def acceptUsageFileAction(self,id):
        return connect_Env.getApiClient().post("usage/files",id,"accept")

    def rejectUsageFileAction(self,id):
        return connect_Env.getApiClient().post("usage/files",id,"reject")

    def closeUsageFileAction(self,id):
        return connect_Env.getApiClient().post("usage/files",id,"close")

    def getProductSpecificUsageFileTemplate(self,product_id):
        return connect_Env.getApiClient().get("usage/products",product_id,"template")
...
class connect_models_Model:
    _hx_class_name = "connect.models.Model"
    __slots__ = ("fieldClassNames",)
    _hx_fields = ["fieldClassNames"]
    _hx_methods = ["toObject", "toString", "_setFieldClassNames", "_getFieldClassName", "__getattr__", "__setattr__"]
...
class connect_models_Conversation(connect_models_IdModel):
    ...
    def createMessage(self,text):
        msg = connect_models_Message.create(self.id,text)
...
class connect_models_Message(connect_models_IdModel):
    ...
    @staticmethod
    def create(conversationId,text):
        msg = connect_Env.getGeneralApi().createConversationMessage(conversationId,haxe_format_JsonPrinter.print(_hx_AnonObject({'text': text}),None,None))
        return connect_models_Model.parse(connect_models_Message,msg)
...
class connect_models_ProductStats(connect_models_Model):
    ...
    __slots__ = ("listing", "agreements", "contracts")
    _hx_fields = ["listing", "agreements", "contracts"]
    _hx_methods = []
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_models_Model
...
class connect_models_Request(connect_models_IdModel):
    ...
    _hx_methods = ["update", "approveByTemplate", "approveByTile", "fail", "inquire", "pend", "assign", "needsMigration", "getConversation"]
    _hx_statics = ["list", "get", "create"]
    _hx_interfaces = []
    _hx_super = connect_models_IdModel
    ...
    def create(request):
        try:
            request1 = connect_Env.getFulfillmentApi().createRequest(request.toString())
            return connect_models_Model.parse(connect_models_Request,request1)
        except Exception as _hx_e:
            _hx_e1 = _hx_e.val if isinstance(_hx_e, _HxException) else _hx_e
            ex = _hx_e1
            return None
...
class connect_native_PythonRequest:
    ...
    def request(method,url,headers,data,timeout):
        import requests
        resp = requests.request(method, url, headers=headers, data=data.encode() if data else None, timeout=timeout)
        return connect_api_Response(resp.status_code,resp.text)
...
class haxe_io_StringInput(haxe_io_BytesInput):
    _hx_class_name = "haxe.io.StringInput"
    __slots__ = ()
    _hx_fields = []
    _hx_methods = []
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = haxe_io_BytesInput


    def __init__(self,s):
        super().__init__(haxe_io_Bytes.ofString(s))
haxe_io_StringInput._hx_class = haxe_io_StringInput
_hx_classes["haxe.io.StringInput"] = haxe_io_StringInput
...
connect_Processor.STEP_PARAM_ID = "__sdk_processor_step"
